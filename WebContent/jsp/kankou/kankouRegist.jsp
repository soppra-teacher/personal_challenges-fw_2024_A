        ...
        <div>
          <table class="layout-table w-100">
            ...
            <tr>
              ...
              <td class="w-75 text-left">
                ...
                <logic:notEmpty name="viewBean" property="revision">
                  <html:text name="inputBean" property="kankouNm" styleClass="input-text-l" readonly="true" />
                </logic:notEmpty>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="w-75 text-left">
                <html:textarea name="inputBean" property="setsumei"  styleClass="input-text-l2" />
              </td>
            </tr>
            ...
            <tr>
              ...
              <!-- 後に用変更　review -->
              <td class="w-75 text-left">
                <html:textarea name="inputBean" property="review" styleClass="input-text-l3" />
              </td>
            </tr>
